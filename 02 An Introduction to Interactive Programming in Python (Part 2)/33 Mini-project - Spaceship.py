...
class Ship:
    ...
    def update(self):
        ...
        self.vel[0] = .99 * self.vel[0]
        self.vel[1] = .99 * self.vel[1]
    ...
    def shoot(self) :
        ...
        self.vel[1] + 5 * angle_to_vector(self.angle)[1]], 0, 0, 
...
def rock_spawner():
    ...
    [.01 * random.randrange(-150, 150), .01 * random.randrange(-150, 150)], 
    2 * math.pi * random.randrange(-100, 100), .001 * random.randrange(-100, 100), 
